    ...
    <div className="max-w-7xl mx-auto">
      ...
      <div className="py-12">
        <div className="grid grid-cols-1 gap-8 md:grid-cols-3">
          <div className="bg-background dark:bg-background p-6 rounded-lg shadow-md card-hover">
      ...
      <div className="bg-background dark:bg-background rounded-lg shadow-md p-8 my-12">
